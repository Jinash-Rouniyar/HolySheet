    ...
    >
      ...
      <div className="container px-4 mx-auto max-w-5xl">
        <div className="flex flex-col items-center text-center space-y-6">
          {/* Badge
          <div 
            className="animate-reveal inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full bg-white border border-green-200 shadow-sm mb-4 cell"
          >
            <span className="flex h-2 w-2 rounded-full bg-primary"></span>
            <span className="text-xs font-medium">Introducing Celina AI</span>
          </div> */}
          ...
          <p className="animate-reveal stagger-2 text-lg md:text-xl text-gray-600 max-w-3xl font-light mb-4">
            Built to make your spreadsheet use more prdouctive. Celina is the best way to use spreadsheet with AI.
          </p>
